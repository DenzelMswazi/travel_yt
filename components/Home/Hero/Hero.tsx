    ...
    <div className='relative w-full h-[120vh] sm:h-[100vh]'>
        ...
        <div className='absolute z-[100] w-full h-full top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
            <div className='flex items-center justify-center flex-col w-full h-full'>
                ...
                {/* Search Box */}
                <SearchBox />
                <Link href="#" className='rounded px-14 md:px-28 -mt-8 py-2.5 overflow-hidden group bg-rose-600 relative hover:bg-gradient-to-r hover:from-red-500 hover:to-red-400 text-white hover:ring-2 hover:ring-offset-2
