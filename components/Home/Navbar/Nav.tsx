    ...
    <div className='bg-blue-950 transition-all duuration-200 h-[12vh] z-[1000]'>
        <div className='flex items-center h-full justify-between w-[90%] xl:w-[80%] mx-auto'>
            ...
            <div className='flex items-center space-x-2'>
                ...
                <h1 className='text-xl md:text-2xl text-white uppercase font-bold'>Trippie</h1>
            </div>
            {/* Nav Links */}
            <div className='hidden lg:flex items-center space-x-10'>
                {navLinks.map((link) => {
                    return <Link href={link.url} key={link.id}>
                        ...
                        after:absolute after:h-[3px] after:bg-yellow-300 after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition duration-300 after:origin-right'>{link.label}</p>
                    </Link>
                })}
            </div>
            {/* buttons */}
